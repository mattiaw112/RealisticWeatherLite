...
function RW_AmbientSoundSystem:updateMask()
    ...
    -- Sincronizzazione con la bufera personalizzata del mod principale
    local customBlizzard = false
    if RealisticWeatherLite ~= nil then
        customBlizzard = RealisticWeatherLite.isBlizzard or false
    end

    self.conditionFlags:setModifierValue("blizzard", customBlizzard)
